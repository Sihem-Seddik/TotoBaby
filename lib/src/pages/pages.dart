    ...
    setState(() {
      ...
      switch (tabItem) {
        case 0:
          ...
          break;
        case 1:
          widget.currentPage = DetailsWidget(
            routeArgument: RouteArgument(
              id: '1',
              heroTag: '',
            ),
        ...
        case 2:
          widget.currentPage =
              MenuWidget(routeArgument: RouteArgument(id: '1'));
          break;
        case 3:
          widget.currentPage =
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                icon: new Icon(Icons.local_mall), label: ''),
            BottomNavigationBarItem(icon: new Icon(Icons.favorite), label: ''),
          ],
        ),
      ),
    );
